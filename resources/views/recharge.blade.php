                ...
                <tbody class="divide-y divide-gray-800 text-gray-300">
                    ...
                    <tr class="hover:bg-white/5 transition-colors">
                        ...
                        <td class="px-6 py-4 text-sm">
                            ...
                            <a href="{{ asset('storage/' . $recharge->proof_image) }}" target="_blank" class="text-indigo-400 hover:text-indigo-300 underline text-xs font-bold flex items-center gap-1">
